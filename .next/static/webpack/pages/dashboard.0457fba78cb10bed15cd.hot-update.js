      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 4;
            return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_6___default()("".concat(url, "+").concat(apiKey));
